                ...
                case SellAction.Create:
                    {
                        ...
                        //Sliding price logic.  use econdatamanager for sliding logic

                       // if (EconomyConsts.PriceScaling)
                            if (SellToMerchant || UseBankBuyPrice)
                        {
                            ...
                            if (UseBankBuyPrice)
                                ...
                                if (!EconomyConsts.PriceScaling) ItemPrice = marketItem.BuyPrice; else ItemPrice = ReactivePricing.PriceAdjust(marketItem.BuyPrice, marketItem.Quantity);
