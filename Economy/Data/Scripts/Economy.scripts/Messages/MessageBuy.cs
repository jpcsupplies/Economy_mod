        ...
        public override void ProcessServer()
        {
            ...
            if (BuyFromMerchant || UseBankSellPrice)
            {
                ...
                if (UseBankSellPrice)
                    ...
                    if (!EconomyConsts.PriceScaling) ItemPrice = marketItem.SellPrice; else ItemPrice = EconDataManager.PriceAdjust(marketItem.SellPrice, marketItem.Quantity, PricingBias.Sell);
